...
n.decrement=function(){var t=parseFloat(n.val)-n.step
return t<n.min?void(n.val=n.min.toFixed(n.decimals)):(n.val=t.toFixed(n.decimals),void n.$emit("estimateEdit",t))},n.increment=function(){var t=parseFloat(n.val)+n.step
